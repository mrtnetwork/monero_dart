...
class DaemonRequestAddAuxPow extends MoneroDaemonRequestParam<
    DaemonAddAuxPowResponse, Map<String, dynamic>> {
  DaemonRequestAddAuxPow(
      {required this.blocktemplateBlob, required this.auxPow});
