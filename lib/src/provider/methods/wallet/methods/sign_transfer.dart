...
class WalletRequestSignTransfer extends MoneroWalletRequestParam<
    WalletRPCSignTransferResponse, Map<String, dynamic>> {
  WalletRequestSignTransfer(
      {required this.unsignedTxSet, this.exportRaw, this.getTxKey});
